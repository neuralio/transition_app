...
class CommodityMarketAgent(mesa.Agent):
    ...
    def __init__(self,
        ...
        # Market state (use provided initial values or defaults)
        if initial_prices:
        ...
        # Track if initial values have been preserved
        self._step_count = 0
    ...
    def step(self):
        ...
        # Skip on first step to preserve initial demand values for display
